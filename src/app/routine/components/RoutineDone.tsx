...
import { appendRun, useRoutines } from "@/lib/data";
import {
  clearRunStart,
  RUN_START_KEY,
  type RunStart,
 ...
 * 다만 기록이 서버 API 호출(비동기)이 되면서, 같은 시작 표시로 effect 가 두 번(StrictMode)
 * 겹쳐 돌 수 있어 `sentRef` 로 중복 호출만 막는다 — 소비 자체는 여전히 표시가 담당한다.
 *
 * ⚠️ **알려진 한계 2가지**
